...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "hello@ulugdev.uz",
    href: "mailto:hello@ulugdev.uz",
  },
  {
    icon: SiTelegram,
    label: "Telegram",
...
const socialLinks = [
  ...
  },
  {
    icon: SiLinkedin,
    label: "LinkedIn",
    href: "https://linkedin.com/in/ulugdev",
  },
  {
    icon: SiTelegram,
    label: "Telegram",
    ...
    <section ref={sectionRef} id="contact" className="px-4 py-24 sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          <div
            ref={formRef}
            className="order-2 rounded-2xl border border-zinc-800 bg-zinc-900/30 p-6 backdrop-blur-sm sm:p-8 lg:order-1 lg:col-span-3"
          >
            ...
            {isSuccess ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-emerald-500/10 ring-1 ring-emerald-500/20">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="group relative w-full overflow-hidden rounded-xl bg-white py-6 text-base font-semibold text-black transition-all duration-300 hover:bg-zinc-200"
          ...
          {/* Contact Info */}
          <div ref={infoRef} className="order-1 space-y-4 lg:order-2 lg:col-span-2">
            ...
            {/* CTA Card */}
            <div className="group relative overflow-hidden rounded-xl border border-zinc-800 bg-gradient-to-br from-violet-500/10 via-purple-500/5 to-fuchsia-500/10 p-4 transition-all duration-500 hover:border-purple-500/30 opacity-100! sm:rounded-2xl sm:p-6">
